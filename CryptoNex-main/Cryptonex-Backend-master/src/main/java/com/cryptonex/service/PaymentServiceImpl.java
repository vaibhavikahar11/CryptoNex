...
public class PaymentServiceImpl implements PaymentService{
    ...
    public PaymentResponse createRazorpayPaymentLink(User user,
        ...
        try {
            ...
            paymentLinkRequest.put("callback_url","https://cryptonex-frontend.vercel.app/wallet/"+orderId);
    ...
    public PaymentResponse createStripePaymentLink(User user, Long amount,Long orderId) throws StripeException {
        ...
        SessionCreateParams params = SessionCreateParams.builder()
                ...
                .setSuccessUrl("https://cryptonex-frontend.vercel.app/wallet?order_id="+orderId)
                .setCancelUrl("https://cryptonex-frontend.vercel.app/payment/cancel")
