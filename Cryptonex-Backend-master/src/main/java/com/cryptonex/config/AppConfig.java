	 ...
	 @Bean
	    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
	        ...
	        http.sessionManagement(management -> management.sessionCreationPolicy(SessionCreationPolicy.STATELESS))
	                .authorizeHttpRequests(Authorize -> Authorize
	                                // Public coin data endpoints — no JWT required
	                                .requestMatchers(HttpMethod.GET, "/coins/**").permitAll()
	                                .requestMatchers(HttpMethod.GET, "/market-chart/**").permitAll()
	                                .requestMatchers(HttpMethod.GET, "/search/coin").permitAll()
	    ...
	    private CorsConfigurationSource corsConfigurationSource() {
	        return new CorsConfigurationSource() {
				...
				"https://cryptonex-frontend-shivam-jondhales-projects.vercel.app/",
				"https://cryptonex-frontend.vercel.app/",
